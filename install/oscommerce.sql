...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Primary Currency Converter', 'CURRENCY_SERVER_PRIMARY', 'fixer', 'Primary currency converter.<br>Fixer requires sign up for access key.', '1', '28',  'tep_cfg_select_option(array(\'fixer\', \'oanda\', \'xe\'), ', now());
